...
def simple_stdio_adapter(command: list, event: Dict[str, Any], context) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        stdout, stderr = process.communicate(input=request_json, timeout=25)  # Lambda timeout buffer
        ...
        return {
            ...
            "error": {
                "code": -32603,
                "message": "MCP server process timed out"
            }
        }
...
def get_user_credentials(user_id):
    ...
    try:
        ...
        logger.info(f"Credentials created successfully")

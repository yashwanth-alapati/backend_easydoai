...
class GmailLambdaService:
    ...
    async def call_gmail_tool(self, tool_name: str, user_id: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    async def get_gmail_messages(self, user_id: str, query: str = "", max_results: int = 10) -> Dict[str, Any]:
    ...
    async def send_gmail_message(self, user_id: str, to: str, subject: str, body: str) -> Dict[str, Any]:
